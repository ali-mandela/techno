...
function CI() {
  return (<>
    <Navbar/>
  <PagesHeader det={{url:banner,top:"Services",title:"Cloud Integrations"}}/>

    <div className='CIouter'>
    <div className='CIinner'>
