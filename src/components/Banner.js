        ...
        <div className='w-full h-screen bg-cover rounded-bl-3xl rounded-br-3xl' style={{ backgroundImage: `url(${homeBanner})` }}>
            <div class="grid grid-cols-2 gap-4 ">
                <div className='pl-24 py-52'>
                    ...
                    <h1 className='text-white font-semibold text-2xl py-10'>Experts that enable customer success with the implementation of right set of ZOHO tools</h1>

                    <button
                        class="py-5 px-8 rounded-full text-2xl text-white bg-orange-500 uppercase">
                        know more
                    </button>
                </div>
