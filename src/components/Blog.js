...
const Blog = () => {
    return (
        <div className='p-16 bg-white blogdiv'>
            <div className='blogdivv'>
                <video className='w-auto h-96 hero container max-w-screen-sm mx-auto text-end  justify-center ' src="https://technoisolutions.com/wp-content/uploads/2022/05/cyber-security-services107.mp4" controls></video>
            </div>
            <h1 className='text-violet-700 font-bold text-4xl  my-8 text-center font-Poppins'>Blogs</h1>
            <div className='grid  grid-flow-col grid-cols-3 gap-4 mt-6 blogdivtext'>
                <div className='bg-slate-200 rounded-2xl p-8 blogdivtext-1'>
